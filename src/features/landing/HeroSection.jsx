        ...
        <section className="bg-bg text-white relative overflow-hidden min-h-[90dvh] flex items-center justify-center">
            ...
            <div className="container mx-auto px-6 py-32 relative z-10 flex flex-col items-center justify-center w-full max-w-5xl text-center">
                ...
                <p className="text-lg md:text-xl text-text-dim max-w-2xl mx-auto leading-relaxed mb-10">
                    Instantly connect patients with verified blood donors. No public phone numbers, 100% secure, and matched in under 60 seconds.
                </p>
                
                {/* CTA Buttons */}
                <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
                    <Link href="/patient/register" className="bg-highlight hover:bg-highlight/90 text-black font-semibold py-4 px-8 rounded-md transition-all min-w-[200px] shadow-sm">
                        Find a Donor
                    </Link>
                    <Link href="/donor/register" className="bg-surface-2 hover:bg-surface-3 text-white border border-white/10 font-semibold py-4 px-8 rounded-md transition-all min-w-[200px]">
                        Register as Donor
                    </Link>
                </div>
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl border-t border-white/10 pt-10">
                    <div className="flex flex-col items-center justify-center space-y-2">
                        ...
                        <div className="text-sm font-medium text-text-dim">Live Connections</div>
                    </div>
                    <div className="flex flex-col items-center justify-center space-y-2">
                    ...
                    <div className="flex flex-col items-center justify-center space-y-2">
                        ...
                        <div className="text-sm font-medium text-text-dim">Average Match Time</div>
                    </div>
                </div>
