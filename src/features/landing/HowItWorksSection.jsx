...
const HowItWorksSection = () => {
  ...
  return (
    <section id="howitworks" className="py-32 bg-bg relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-7xl">
        <div className="text-center mb-20">
          <span className="text-donor font-semibold tracking-wider uppercase text-xs mb-4 block">
            Simple Steps
          </span>
          ...
          <p className="text-lg text-text-dim mt-4 max-w-2xl mx-auto">
            A simple and fast way to connect donors and patients when it matters
            most.
          </p>
        </div>
