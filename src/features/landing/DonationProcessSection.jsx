        ...
        <section id="process" className="py-32 bg-surface relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 max-w-7xl">
                <div className="text-center mb-20 max-w-3xl mx-auto space-y-4">
                    <span className="text-highlight font-semibold tracking-wider uppercase text-xs block">Connecting Lives</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative max-w-5xl mx-auto">
                    ...
                    <div className="relative group bg-bg p-8 rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-300 flex flex-col items-center text-center">
                        <div className="w-16 h-16 rounded-full bg-surface-2 border border-white/10 flex items-center justify-center mb-6 shadow-sm group-hover:bg-surface-3 transition-colors">
                            <Stethoscope className="w-6 h-6 text-donor" />
                        </div>
                        <h3 className="text-xl font-bold text-white tracking-tight mb-3 group-hover:text-highlight transition-colors">1. Health & Safety First</h3>
                        <p className="text-text-muted text-sm leading-relaxed mb-2">
                            Before registering, ensure you are in good health, smoke-free, and tested clean of any active blood diseases. Maintaining pristine health standards is vital to guarantee that your gift of life is safe for the patient.
                        </p>
                    </div>
                    ...
                    <div className="relative group bg-bg p-8 rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-300 flex flex-col items-center text-center">
                        ...
                        <h3 className="text-xl font-bold text-white tracking-tight mb-3 group-hover:text-highlight transition-colors">2. Declare Your Profile</h3>
                        <p className="text-text-muted text-sm leading-relaxed mb-2">
                    ...
                    <div className="relative group bg-bg p-8 rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-300 flex flex-col items-center text-center">
                        ...
                        <h3 className="text-xl font-bold text-white tracking-tight mb-3 group-hover:text-highlight transition-colors">3. Patient Request & Match</h3>
                        <p className="text-text-muted text-sm leading-relaxed mb-2">
