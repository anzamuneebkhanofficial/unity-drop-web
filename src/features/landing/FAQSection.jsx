...
const faqs = [
  {
    question:
      'Is my personal contact and health information secure on Unity Drop?',
    answer:
  ...
  {
    question:
      'How does the system match and notify donors when a patient sends a request?',
    answer:
  ...
  {
    question:
      'How does blood compatibility work, and which blood types are rare or hard to find?',
    answer:
  ...
  {
    question:
      'How often can I safely donate blood, and who is eligible to register as a donor?',
    answer:
...
const FAQSection = () => {
  return (
    <section id="faq" className="bg-bg py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-surface-2 border border-white/5 rounded-xl overflow-hidden transition-all hover:border-white/20 group"
            >
