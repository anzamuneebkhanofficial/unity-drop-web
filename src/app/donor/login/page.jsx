...
const DonorLoginPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (result) router.push('/donor/dashboard');
  };
  ...
  return (
    <div className="flex min-h-screen bg-neutral-950 text-white">
      ...
      <div className="hidden md:flex flex-col justify-center items-center w-1/2 bg-gradient-to-br from-neutral-800 to-neutral-900 p-10">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight">Donor Panel</h1>
        <p className="text-gray-400 mt-4 text-lg text-center max-w-sm">
          Secure login to manage your donations, update your details, and track
          your contributions.
        </p>
      </div>
