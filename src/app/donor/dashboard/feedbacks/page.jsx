          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="bg-[#121212] border border-white/5 rounded-3xl p-8 md:p-10">
              ...
              <div className="mb-8">
                ...
                <textarea
                  className="w-full h-32 p-5 bg-[#0f0f0f] border border-white/5 rounded-2xl text-gray-200 focus:outline-none focus:border-donor/50 transition-all placeholder:text-gray-500 resize-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-6">
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-[#1a1a1a] rounded-lg appearance-none cursor-pointer accent-donor transition-all"
                  />
