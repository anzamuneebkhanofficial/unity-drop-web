                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      id="feedback-message"
                      disabled={loading}
                      className="w-full h-32 p-5 bg-[#0f0f0f] border border-white/5 rounded-2xl text-gray-200 focus:outline-none focus:border-highlight/50 transition-all placeholder:text-gray-500 resize-none disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <input
                        ...
                        className="w-full h-2 bg-[#1a1a1a] rounded-lg appearance-none cursor-pointer accent-highlight transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                    )}
                  />
